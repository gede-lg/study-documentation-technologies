...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .addServersItem(new Server().url("https://api.example.com").description("Servidor de Produção"))
            .addServersItem(new Server().url("https://dev-api.example.com").description("Servidor de Desenvolvimento"));
    }
}
```
...
public class ApiController {
    ...
    @Server(url = "https://api.example.com", description = "Servidor de Produção")
...
@OpenAPIDefinition(
    ...
    servers = {
        @Server(url = "https://dev.example.com/api", description = "Development server"),
