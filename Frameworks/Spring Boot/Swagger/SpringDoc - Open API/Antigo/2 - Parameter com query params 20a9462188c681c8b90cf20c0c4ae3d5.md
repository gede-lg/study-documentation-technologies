...
```java
import org.springframework.web.bind.annotation.GetMapping;import org.springframework.web.bind.annotation.RequestParam;import org.springframework.web.bind.annotation.RestController;import io.swagger.v3.oas.annotations.Operation;import io.swagger.v3.oas.annotations.Parameter;import io.swagger.v3.oas.annotations.media.Schema;@RestControllerpublic class ExampleController {    @GetMapping("/example")    @Operation(summary = "Obtém informações baseadas no parâmetro de entrada")    public String getExample(@RequestParam @Parameter(description = "Descrição do parâmetro de entrada",                                                      required = true,                                                      schema = @Schema(type = "string", defaultValue = "default"))                             String input) {        return "Input recebido: " + input;    }}
```
